...
class CategoryAdmin(admin.ModelAdmin):    
    list_display = ('id','image_tag','name','main_category')
...
class Sub_CategoryAdmin(admin.ModelAdmin):    
    list_display = ('id','image_tag','name','category')
...
class Product_Admin(admin.ModelAdmin):
    ...
    list_display = ('id','image_tag','product_name','category','brand','section','total_quantity','total_availability','model_name','price','discount','slug')
